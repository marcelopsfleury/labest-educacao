...
##### Percetual de matrículas em relação à população estimada para os anos de 2019, 2020 e 2021
...
# Lendo dados do Enem (anos de 2019, 2020, 2021)
path_inep_censo = ['./extracao/dados_zip/microdados_ed_basica_2019.csv',
                    './extracao/dados_zip/microdados_ed_basica_2020.csv',
                    './extracao/dados_zip/microdados_ed_basica_2021.csv'
                    ]
df_censo_basica_ano = []
...
df_estimativa_pop = pd.read_csv(path_ibge_pop, dtype={'COD_MUN':object})
...
path_output = './dados_saida/perc_mat_ensino_medio.csv'
df_mat_mun_rgi.to_csv(path_output, index=False, sep=',')